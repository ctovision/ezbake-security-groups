...
public class GroupIdGraphPersistenceTest {
    ...
    public static void start() throws Exception {
        ...
        ezConfiguration.setProperty(EzBakePropertyConstants.REDIS_HOST, InetAddress.getLocalHost().getCanonicalHostName());
    ...
    @Test
    public void clearRedisTest() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException {
