...
public class EzGroupsGraphTest extends GraphCommonSetup {
    ...
    public void siblingDuplicationFromCommonTest() throws VertexExistsException, UserNotFoundException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
    ...
    @Test(expected=VertexExistsException.class)
    public void siblingDuplicationFromGroupTest() throws VertexExistsException, UserNotFoundException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One");
    ...
    @Test
    public void createWithRequireFlags() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException {
    ...
    @Test
    public void ownerGetsDirectAdminEdges() throws VertexExistsException, InvalidVertexTypeException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
    ...
    @Test
    public void createChildPathExistsTest() throws VertexExistsException, InvalidVertexTypeException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex().getId();
    ...
    public void regularUsersCantAddAppGroups() throws UserNotFoundException, VertexExistsException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One");
        Group g1 = graph.addGroup(BaseVertex.VertexType.USER, "User1", "User1sAppGroup", graph.appGroupId);
    }


    @Test
    public void testAddUserToGroupPermissions() throws UserNotFoundException, AccessDeniedException, VertexExistsException, InvalidVertexTypeException, VertexNotFoundException, IndexUnavailableException {
    ...
    @Test
    public void userGroupsList() throws VertexExistsException, UserNotFoundException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex().getId();
        Group g1 = graph.addGroup(BaseVertex.VertexType.USER, "User1", "group1");
        Group g2 = graph.addGroup(BaseVertex.VertexType.USER, "User1", "group2", g1);
        Group g3 = graph.addGroup(BaseVertex.VertexType.USER, "User1", "group3", g2);
    ...
    @Test
    public void userExplicitGroups() throws UserNotFoundException, VertexExistsException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        // Create some users
        ...
        graph.addUserToGroup(BaseVertex.VertexType.USER, "user", g1.asVertex().getId());
        graph.addUserToGroup(BaseVertex.VertexType.USER, "user", g4.asVertex().getId());
    ...
    @Test
    public void getUserGroupsOnlyActive() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException, VertexNotFoundException {
    ...
    @Test
    public void appUserGroupsList() throws VertexExistsException, InvalidVertexTypeException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
    ...
    @Test
    public void groupMembersList() throws VertexExistsException, UserNotFoundException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        Vertex user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex();
        ...
        // Assign app 1 to g1
        graph.addUserToGroup(BaseVertex.VertexType.APP_USER, "app1", g1);
        ...
        // Assign app 2 to g1
        graph.addUserToGroup(BaseVertex.VertexType.APP_USER, "app2", g1);
    ...
    @Test
    public void groupMembersExplicit() throws UserNotFoundException, VertexExistsException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        Vertex user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex();
        ...
        // Add user2 explictly
        graph.addUserToGroup(BaseVertex.VertexType.USER, "User2", g1id);
        ...
        // Add user3 explictly
        graph.addUserToGroup(BaseVertex.VertexType.USER, "User3", g1id);
    ...
    @Test
    public void removeUserFromGroupTest() throws VertexExistsException, UserNotFoundException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        // Create the group
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex().getId();
        Group g1 = graph.addGroup(BaseVertex.VertexType.USER, "User1", "group1");
        Object g1id = g1.asVertex().getId();
    ...
    @Test
    public void userModifyPrincipal() throws UserNotFoundException, VertexExistsException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex().getId();
    ...
    @Test
    public void deleteUser() throws UserNotFoundException, VertexExistsException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
    ...
    @Test
    public void activeDeactiveTest() throws UserNotFoundException, VertexExistsException, InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException {
    ...
    @Test
    public void groupActiveNotTest() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException, VertexNotFoundException {
    ...
    @Test
    public void groupActiveNotChildTest() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException, VertexNotFoundException {
        // Create the user to create the group
        Object user1 = graph.addUser(BaseVertex.VertexType.USER, "User1", "User One").asVertex().getId();
        Object user2 = graph.addUser(BaseVertex.VertexType.USER, "User2", "User One").asVertex().getId();
    ...
    @Test
    public void testGetGroups() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException {
        String id = "User1";
    ...
    @Test
    public void testChildGroups() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, VertexNotFoundException, IndexUnavailableException {
        String id = "User1";
        BaseVertex.VertexType type = BaseVertex.VertexType.USER;
        String groupName1 = "mygroup";
        String groupName2 = "mygroup2";
    ...
    @Test
    public void testChildGroupsNestedLower() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, VertexNotFoundException, IndexUnavailableException {
        String id = "User1";
        BaseVertex.VertexType type = BaseVertex.VertexType.USER;
        String groupName1 = "mygroup";
        String groupName2 = "mygroup2";
    ...
    @Test
    public void testChildGroupsRecurse() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, VertexNotFoundException, IndexUnavailableException {
        String id = "User1";
        BaseVertex.VertexType type = BaseVertex.VertexType.USER;
        String groupName1 = "mygroup";
        String groupName2 = "mygroup2";
     ...
     */
    @Test
    public void testGetChildrenMultiUser() throws VertexNotFoundException, UserNotFoundException, AccessDeniedException, VertexExistsException, InvalidVertexTypeException, IndexUnavailableException {
        String id = "User1";
        BaseVertex.VertexType type = BaseVertex.VertexType.USER;
        String groupName1 = "mygroup";
        String groupName2 = "mygroup2";
    ...
    @Test
    public void testAdminReadRequiredToViewChildren() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, VertexNotFoundException, IndexUnavailableException {
        String id = "User1";
        String id2 = "User2";
        BaseVertex.VertexType type = BaseVertex.VertexType.USER;
        String groupName1 = "mygroup";
    ...
    @Test
    public void testManageEdges() throws UserNotFoundException, AccessDeniedException, VertexExistsException, InvalidVertexTypeException, VertexNotFoundException, IndexUnavailableException {
        String id = "User1";
        String groupName1 = "mygroup";
        BaseVertex.VertexType type = BaseVertex.VertexType.USER;
        String expectedGroup1 = Joiner.on(".").join(Group.COMMON_GROUP, groupName1);
    ...
    @Test
    public void userPermissionHelperTest() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, VertexNotFoundException, IndexUnavailableException {
        String userId = "User1";
     ...
     */
    @Test
    public void testMyLogic() throws UserNotFoundException, AccessDeniedException, VertexExistsException, InvalidVertexTypeException, VertexNotFoundException, IndexUnavailableException {
        ...
        graph.addUserToGroup(BaseVertex.VertexType.USER, "User2", g2.asVertex().getId(), true, true, true, true, true);
