...
public class TransactionRollbackTest {
    ...
    @Test
    public void testRollbackIfIdUnavailableForAddUser() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException {
        idProvider.id = -1;
        try {
    ...
    @Test
    public void testRollbackIfAddGroup() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException {
        graph.addUser(BaseVertex.VertexType.USER, "user1", "");
