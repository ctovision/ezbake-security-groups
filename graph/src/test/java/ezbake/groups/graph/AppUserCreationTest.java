...
public class AppUserCreationTest extends GraphCommonSetup {
    ...
    public void appUserDuplicationTest() throws VertexExistsException, InvalidVertexTypeException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
    ...
    @Test
    public void appUsersGetAppAccessGroupTest() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, IndexUnavailableException {
    ...
    @Test
    public void appUserHasDataAccessOnAppAccess() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, IndexUnavailableException {
    ...
    @Test
    public void appAccessGroupInheritsDataRead() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, IndexUnavailableException {
        Object app = graph.addUser(BaseVertex.VertexType.APP_USER, "app1", "Application One").asVertex().getId();
        Object appGroupId = graph.getGraph().query().has(Group.GROUP_NAME, Group.COMMON_GROUP+"."+Group.APP_ACCESS_GROUP+".Application One").vertices().iterator().next().getId();
    ...
    public void addChildGroupToAppAccessGroup() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, IndexUnavailableException {
        Object app = graph.addUser(BaseVertex.VertexType.APP_USER, "app1", "Application One").asVertex().getId();
    ...
    @Test(expected=AccessDeniedException.class)
    public void addChildGroupToAppAccessGroupAsRegularUser() throws InvalidVertexTypeException, AccessDeniedException, UserNotFoundException, VertexExistsException, IndexUnavailableException {
        Object app = graph.addUser(BaseVertex.VertexType.APP_USER, "app1", "Application One").asVertex().getId();
        Vertex appGroup = graph.getGraph().query().has(Group.GROUP_NAME, Group.COMMON_GROUP+"."+Group.APP_ACCESS_GROUP+".Application One").vertices().iterator().next();
    ...
    @Test
    public void appUsersGetAppGroupTest() throws VertexExistsException, InvalidVertexTypeException, UserNotFoundException, AccessDeniedException, IndexUnavailableException {
        Object app = graph.addUser(BaseVertex.VertexType.APP_USER, "app1", "Application One").asVertex().getId();
