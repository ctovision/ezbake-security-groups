...
public class SpecialAppGroupQueryTest extends GraphCommonSetup {
    ...
    @Test
    public void testJustOne() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException, VertexNotFoundException {
    ...
    @Test
    public void testMultipleApps() throws InvalidVertexTypeException, AccessDeniedException, IndexUnavailableException, UserNotFoundException, VertexExistsException, VertexNotFoundException {
        // Create an apps subgroup
